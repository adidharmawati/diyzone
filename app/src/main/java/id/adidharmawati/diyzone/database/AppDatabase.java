package id.adidharmawati.diyzone.database;
...
import id.adidharmawati.diyzone.database.dao.TutorialDao;
...
@Database(entities = {User.class, Tutorial.class}, version = 1)
public abstract class AppDatabase extends RoomDatabase {
    ...
    @VisibleForTesting
    public static final String DATABASE_NAME= "db_diy";
